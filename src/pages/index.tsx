...
export default function Home() {
    ...
    const aircraft= useRef<HTMLInputElement>()
    const hours = useRef<HTMLInputElement>()
    const simulator = useRef<HTMLInputElement>()
    const others = useRef<HTMLInputElement>()
    const vk = useRef<HTMLInputElement>()
